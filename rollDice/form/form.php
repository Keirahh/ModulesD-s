        ...
        <div class="col-6">
            <form action="rollDice.php" method="POST">
                <p>Nombre de dès à 2 faces<br>
                    <input type="number" name="2" class="number-of-dice" min="0" value="0">
                </p>
                <p>Nombre de dès à 4 faces<br>
                    <input type="number" name="4" class="number-of-dice" min="0" value="0">
                </p>
                <p>Nombre de dès à 6 faces<br>
                    <input type="number" name="6" class="number-of-dice" min="0" value="0">
                </p>
                <p>Nombre de dès à 8 faces<br>
                    <input type="number" name="8" class="number-of-dice" min="0" value="0">
                </p>
            </div>
            <div class="col-6">
                <p>Nombre de dès à 10 faces<br>
                    <input type="number" name="10" class="number-of-dice" min="0" value="0">
                </p>
                <p>Nombre de dès à 12 faces<br>
                    <input type="number" name="12" class="number-of-dice" min="0" value="0">
                </p>
                <p>Nombre de dès à 20 faces<br>
                    <input type="number" name="20" class="number-of-dice" min="0" value="0">
                </p>
